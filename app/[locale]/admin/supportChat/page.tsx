...
const AdminSupportChat = () => {
        ...
        if (data.type === "connection") {
          ...
          // If it's a single message, append it
            ...
            // If it's for a different ticket, show a notification
              ...
              if (ticketDetails) {
                toast.info(`${t("newMessageFrom")} ${ticketDetails.agencyName || t("agency")}`);
          ...
          toast.success(`${t("newTicketFrom")} ${data.ticket.agencyName || t("agency")}`);
  ...
  // Send message
  const sendMessage = () => {
    if (!messageInput.trim() || !isConnected || !socketRef.current || !selectedAgencyId) return;
            ...
            <CardHeader className="pb-2">
              <div className="flex justify-between items-center">
                <div>
                  ...
                  <CardDescription>
                    {selectedTicket 
                      ? tickets.find(t => t.id === selectedTicket)?.agencyName || t("agency")
                ...
                {selectedTicket && (
                  <Button 
                    ...
                    disabled={!selectedTicket || tickets.find(t => t.id === selectedTicket)?.status === "closed"}
                  >
            ...
            <CardFooter>
              <div className="w-full flex items-center space-x-2">
                <Input
                  ...
                  disabled={!selectedTicket || !isConnected || tickets.find(t => t.id === selectedTicket)?.status === "closed"}
                  onKeyDown={(event) => {
