...
export default async function AgencyBookingsPage() {
  ...
  if (session.user.role !== "agency owner" && session.user.role !== "employee" && session.user.role !== "admin") {
    redirect("/");
  }
    ...
    return (
      <div className="container py-10">
        ...
        <div className="p-8 text-center">
          <p className="text-red-500">Failed to load customer bookings. Please try again later.</p>
        </div>
      </div>
    );
  }
