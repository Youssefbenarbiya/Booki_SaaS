...
export function NotificationBell() {
  ...
  const fetchNotifications = async () => {
    try {
      ...
      // Get unread count
      const newUnreadCount = data.data.filter((n: AdminNotification) => !n.isRead).length
      
      // Play sound if there are new notifications
      if (newUnreadCount > previousNotificationCount && !isOpen && audioRef.current) {
  ...
  return (
    <>
      ...
      <audio ref={audioRef} src="/assets/notification.wav" preload="auto" />
    </>
  )
}