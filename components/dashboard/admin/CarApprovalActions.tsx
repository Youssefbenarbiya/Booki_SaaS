...
export function CarApprovalActions({ offerId }: { offerId: number }) {
  ...
  const handleReject = async () => {
    ...
    try {
      const result = await rejectCar(offerId, rejectionReason)
      if (result.success) {
  ...
  return (
    <>
      ...
      <Dialog open={rejectionDialogOpen} onOpenChange={setRejectionDialogOpen}>
        <DialogContent>
          <DialogHeader>
            <DialogTitle>Reject Car</DialogTitle>
            <DialogDescription>
              Please provide a reason for rejecting this car. This will be sent to the agency.
            </DialogDescription>
          </DialogHeader>
          ...
          <DialogFooter>
            ...
            <Button 
              ...
              disabled={isLoading.reject}
            >
              {isLoading.reject ? "Rejecting..." : "Reject Car"}
            </Button>
          </DialogFooter>
        </DialogContent>
      </Dialog>
